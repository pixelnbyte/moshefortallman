...
const coords = [
  ...
  function checkSelectedPlace(place) {
    ...
    inside ? '✅ Your address is inside the district. <br> <a href="https://voterlookup.elections.ny.gov" target="_blank" style="display:inline-block;padding:8px 16px;margin:4px 4px 4px 0;background-color:#1976d2;color:#fff;text-decoration:none;border-radius:4px;font-weight:500;">Check if you are registered to vote</a> <a href="https://elections.ny.gov/voter-registration-process" target="_blank" style="display:inline-block;padding:8px 16px;margin:4px 4px 4px 0;background-color:#388e3c;color:#fff;text-decoration:none;border-radius:4px;font-weight:500;">Register to vote</a> <a href="https://chat.whatsapp.com/CV7rMftauLY3JrCOF6I8o9" target="_blank" style="display:inline-block;padding:8px 16px;margin:4px 0;background-color:#25D366;color:#fff;text-decoration:none;border-radius:4px;font-weight:500;">\
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16" style="margin-right: 8px; position: relative; top: 2px;">\
...
</svg>Join our community on whatsapp</a>' : '❌ Outside the district';
  // Log the address
